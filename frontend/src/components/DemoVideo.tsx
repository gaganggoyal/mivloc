...
/**
 * "How to use Mivloc" — an auto-playing animated walkthrough, story-style:
        ...
        <div className="h-72 px-5 py-4 flex flex-col items-center justify-center text-center" key={s.id}>
          ...
          {s.id === 'invite' && (
            <div className="w-full space-y-3 demo-in">
              ...
              <div className="bg-navy/80 border border-mint/30 rounded-xl px-3 py-2.5 font-mono text-[10px] text-mint break-all">mivloc.online/invite/AB12CD34</div>
          ...
          {s.id === 'once' && (
            <div className="w-full space-y-3 demo-in">
              ...
              <div className="bg-navy/80 border border-mint/30 rounded-xl px-3 py-2 font-mono text-[10px] text-mint">mivloc.online/once/our-secret-room</div>
