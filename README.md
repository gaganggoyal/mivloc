# 🛡️ SafeChat — Chat Safely. Stay Protected.
...
| **Mobile app** | PWA manifest + Capacitor config → installable and Play-Store-ready. |

## Stack
Next.js 14 (App Router) · Supabase (Auth + Postgres + Realtime) · Tailwind CSS · Web Crypto API · Capacitor

## Quick start
```bash
# 1. Supabase (free) — create project at supabase.com
#    SQL Editor → paste & run database/schema.sql
